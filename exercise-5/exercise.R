...
most_popular_2013 <- names_2013$name[names_2013$prop == max(names_2013$prop)]
...
most_popular_in_year <- function(year) {
  ...
  most_popular_year <- names_year$name[names_year$prop == max(names_year$prop)]
  most_popular_year
}
